...
PYMONGO_GAMES='games'
PYMONGO_SERIES_ID='id'
PYMONGO_SERIES_LENGTH='series_length'
PYMONGO_SERIES_NAME='name'
...
PYMONGO_MVP='mvp'
PYMONGO_BATTING_TITLE='batting_title'
PYMONGO_HOME_RUN_LEADER='home_run_leader'
PYMONGO_TEAM='team'
...
PYMONGO_SEASON_BATTING_STATS_COLLECTION='season_batting_stats'
PYMONGO_SEASON_PITCHING_STATS_COLLECTION='season_pitching_stats'
PYMONGO_TEAM_BATTING_STATS_COLLECTION='team_batting_stats'
PYMONGO_TEAM_PITCHING_STATS_COLLECTION='team_pitching_stats'
